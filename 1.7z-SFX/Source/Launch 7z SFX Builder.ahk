...
; ========================================
global PROGRAM_NAME := "7z SFX Builder"                                    ; Display name of the program
global PROGRAM_PATH := "C:\Program Files (x86)\7z SFX Builder\7z SFX Builder.exe"      ; Full path to the executable
